...
var _Vector3d_instances, updateFromAngle_fn;
var _Vector3d = class _Vector3d {
  constructor(x = originPoint.x, y = originPoint.y, z = originPoint.z) {
    __privateAdd(this, _Vector3d_instances);
  ...
  set angle(angle) {
    __privateMethod(this, _Vector3d_instances, updateFromAngle_fn).call(this, angle, this.length);
  }
  get length() {
    return Math.sqrt(this.getLengthSq());
  }
  set length(length) {
    __privateMethod(this, _Vector3d_instances, updateFromAngle_fn).call(this, this.angle, length);
  }
  static clone(source) {
...
_Vector3d_instances = new WeakSet();
updateFromAngle_fn = function(angle, length) {
  this.x = Math.cos(angle) * length;
  this.y = Math.sin(angle) * length;
};
var Vector3d = _Vector3d;
...
function calcExactPositionOrRandomFromSize(data) {
  ...
  return {
    x: (position == null ? void 0 : position.x) ?? getRandom() * size.width,
    y: (position == null ? void 0 : position.y) ?? getRandom() * size.height
  };
}
...
function loadLazyProperty(obj, key, value, factory) {
  if (value !== void 0) {
    const objRecord = obj;
    objRecord[key] ?? (objRecord[key] = factory());
    objRecord[key].load(value);
  }
}
function loadOptionProperty(obj, key, optionClass, ...sources) {
  const objRecord = obj;
  objRecord[key] ?? (objRecord[key] = new optionClass());
  const target = objRecord[key];
  for (const source of sources) {
    target.load(source == null ? void 0 : source[key]);
  }
}
...
var RangedAnimationOptions = class extends AnimationOptions {
  constructor() {
    super(...arguments);
    __publicField(this, "mode", AnimationMode.auto);
    __publicField(this, "startValue", StartValueType.random);
  }
  doLoad(data) {
    super.doLoad(data);
...
var HslAnimation = class extends OptionLoader {
  constructor() {
    super(...arguments);
    __publicField(this, "h", new ColorAnimation(hMin, hMax));
    __publicField(this, "l", new ColorAnimation(lMin, lMax));
    __publicField(this, "s", new ColorAnimation(sMin, sMax));
  }
  doLoad(data) {
    this.h.load(data.h);
    this.s.load(data.s);
...
var AnimatableColor = class _AnimatableColor extends OptionsColor {
  constructor() {
    super(...arguments);
    __publicField(this, "animation", new HslAnimation());
  }
  static create(source, data) {
...
var MoveCenter = class extends OptionLoader {
  constructor() {
    super(...arguments);
    __publicField(this, "mode", PixelMode.percent);
    __publicField(this, "radius", 0);
    __publicField(this, "x", 50);
    __publicField(this, "y", 50);
  }
  doLoad(data) {
...
var MoveGravity = class extends OptionLoader {
  constructor() {
    super(...arguments);
    __publicField(this, "acceleration", 9.81);
    __publicField(this, "enable", false);
    __publicField(this, "inverse", false);
...
var AnimationValueWithRandom = class extends ValueWithRandom {
  constructor() {
    super(...arguments);
    __publicField(this, "animation", new AnimationOptions());
  }
  doLoad(data) {
    super.doLoad(data);
...
var RangedAnimationValueWithRandom = class extends AnimationValueWithRandom {
  constructor() {
    super(...arguments);
    __publicField(this, "animation", new RangedAnimationOptions());
  }
};
...
var MovePath = class extends OptionLoader {
  constructor() {
    ...
    __publicField(this, "delay", new ValueWithRandom());
    __publicField(this, "enable", false);
...
var OutModes = class extends OptionLoader {
  constructor() {
    ...
    __publicField(this, "default", OutMode.out);
...
var Move = class extends OptionLoader {
  constructor() {
    super(...arguments);
    __publicField(this, "angle", new MoveAngle());
    __publicField(this, "center", new MoveCenter());
    __publicField(this, "decay", 0);
    __publicField(this, "direction", MoveDirection.none);
    __publicField(this, "distance", {});
    __publicField(this, "drift", 0);
    __publicField(this, "enable", false);
    __publicField(this, "gravity", new MoveGravity());
    __publicField(this, "outModes", new OutModes());
    __publicField(this, "path", new MovePath());
    __publicField(this, "random", false);
    __publicField(this, "size", false);
    __publicField(this, "speed", 2);
    __publicField(this, "spin", new Spin());
    __publicField(this, "straight", false);
    __publicField(this, "vibrate", false);
...
var ParticlesBounce = class extends OptionLoader {
  constructor() {
    super(...arguments);
    __publicField(this, "horizontal", new ParticlesBounceFactor());
    __publicField(this, "vertical", new ParticlesBounceFactor());
  }
  doLoad(data) {
...
var ParticlesNumberLimit = class extends OptionLoader {
  constructor() {
    super(...arguments);
    __publicField(this, "mode", LimitMode.delete);
    __publicField(this, "value", 0);
  }
  doLoad(data) {
    loadProperty(this, "mode", data.mode);
...
var ParticlesNumber = class extends OptionLoader {
  constructor() {
    super(...arguments);
    __publicField(this, "density", new ParticlesDensity());
    __publicField(this, "limit", new ParticlesNumberLimit());
    __publicField(this, "value", 0);
  }
  doLoad(data) {
...
var ZIndex = class extends ValueWithRandom {
  constructor() {
    super(...arguments);
    __publicField(this, "opacityRate", 1);
    __publicField(this, "sizeRate", 1);
    __publicField(this, "velocityRate", 1);
  }
  doLoad(data) {
    super.doLoad(data);
...
var _container, _pluginManager, _ParticlesOptions_instances, importPalette_fn;
var ParticlesOptions = class extends OptionLoader {
  constructor(pluginManager, container) {
    super();
    __privateAdd(this, _ParticlesOptions_instances);
    __publicField(this, "bounce", new ParticlesBounce());
    __publicField(this, "effect", new Effect());
    __publicField(this, "groups", {});
    __publicField(this, "move", new Move());
    __publicField(this, "number", new ParticlesNumber());
    __publicField(this, "paint");
    __publicField(this, "palette");
    __publicField(this, "reduceDuplicates", false);
    __publicField(this, "shape", new Shape());
    __publicField(this, "zIndex", new ZIndex());
  ...
  doLoad(data) {
    if (data.palette) {
      ...
      __privateMethod(this, _ParticlesOptions_instances, importPalette_fn).call(this, this.palette);
    }
    ...
    if (__privateGet(this, _container)) {
      for (const plugin of __privateGet(this, _pluginManager).plugins) {
        if (plugin.loadParticlesOptions) {
          plugin.loadParticlesOptions(__privateGet(this, _container), this, data);
        }
      }
      const updaters = __privateGet(this, _pluginManager).updaters.get(__privateGet(this, _container));
      if (updaters) {
...
_ParticlesOptions_instances = new WeakSet();
importPalette_fn = function(palette) {
  const paletteData = __privateGet(this, _pluginManager).getPalette(palette);
  if (!paletteData) {
    return;
  }
...
var _container2, _pluginManager2, _Options_instances, importPalette_fn2, importPreset_fn;
var Options = class extends OptionLoader {
  constructor(pluginManager, container) {
    ...
    __publicField(this, "clear", true);
    __publicField(this, "defaultThemes", {});
    __publicField(this, "delay", 0);
    __publicField(this, "detectRetina", true);
    __publicField(this, "duration", 0);
    __publicField(this, "fpsLimit", 120);
    __publicField(this, "fullScreen");
    __publicField(this, "hdr", true);
    __publicField(this, "key");
    __publicField(this, "name");
    __publicField(this, "palette");
    __publicField(this, "particles");
    __publicField(this, "pauseOnBlur", true);
    __publicField(this, "pauseOnOutsideViewport", true);
    __publicField(this, "preset");
    __publicField(this, "resize");
    __publicField(this, "smooth", false);
    __publicField(this, "style", {});
    __publicField(this, "zLayers", 100);
    ...
    this.particles = loadParticlesOptions(__privateGet(this, _pluginManager2), __privateGet(this, _container2));
  ...
  doLoad(data) {
    if (data.preset !== void 0) {
      ...
      executeOnSingleOrMultiple(this.preset, (preset) => {
        __privateMethod(this, _Options_instances, importPreset_fn).call(this, preset);
      });
    }
    if (data.palette !== void 0) {
      this.palette = data.palette;
      __privateMethod(this, _Options_instances, importPalette_fn2).call(this, this.palette);
    }
    ...
    __privateGet(this, _pluginManager2).plugins.forEach((plugin) => {
      plugin.loadOptions(__privateGet(this, _container2), this, data);
    });
  }
};
...
importPalette_fn2 = function(palette) {
  const paletteData = __privateGet(this, _pluginManager2).getPalette(palette);
  if (!paletteData) {
    return;
  }
  this.load({
...
importPreset_fn = function(preset) {
  this.load(__privateGet(this, _pluginManager2).getPreset(preset));
};
...
//# sourceMappingURL=chunk-R4Y3AEWK.js.map
