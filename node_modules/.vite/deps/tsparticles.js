...
var InteractivityPlugin = class {
  ...
  async getPlugin(container) {
    const { InteractivityPluginInstance } = await import("./InteractivityPluginInstance-6ZKRRENE.js");
    return new InteractivityPluginInstance(__privateGet(this, _pluginManager), container);
  }
  loadOptions(container, options, source) {
    ...
    if (!(interactivityOptions == null ? void 0 : interactivityOptions.load)) {
      options.interactivity = interactivityOptions = new Interactivity(__privateGet(this, _pluginManager), container);
    }
    interactivityOptions.load(source == null ? void 0 : source.interactivity);
    const interactors = (_a = __privateGet(this, _pluginManager).interactors) == null ? void 0 : _a.get(container);
    if (!interactors) {
      return;
    }
...
var _dragging, _draggingAbsorber, _instancesManager;
var AbsorbersInteractor = class extends ExternalInteractorBase {
  constructor(container, instancesManager) {
    ...
    __privateAdd(this, _draggingAbsorber);
    ...
    this.handleClickMode = (mode, interactivityData) => {
      ...
      void __privateGet(this, _instancesManager).addAbsorber(container2, absorbersModeOptions, clickPosition);
    };
  }
  clear() {
  }
  ...
  interact(interactivityData, delta) {
    for (const particle of this.container.particles.filter((p) => this.isEnabled(interactivityData, p))) {
      for (const absorber of __privateGet(this, _instancesManager).getArray(this.container)) {
        if (absorber.options.draggable) {
          ...
          if (mouse.clicking && mouse.downPosition) {
            ...
            if (mouseDist <= absorber.size) {
              ...
              __privateSet(this, _draggingAbsorber, absorber);
            }
          } else {
            __privateSet(this, _dragging, false);
            __privateSet(this, _draggingAbsorber, void 0);
          }
          if (__privateGet(this, _dragging) && __privateGet(this, _draggingAbsorber) == absorber && mouse.position) {
...
function getAbsorbersInstancesManager(e) {
  ...
  if (!manager) {
    manager = import("./AbsorbersInstancesManager-YJGQJVIP.js").then(({ AbsorbersInstancesManager }) => new AbsorbersInstancesManager(pluginManager)).catch((error) => {
...
var _instancesManager2;
var AbsorbersPlugin = class {
  constructor(instancesManager) {
    __publicField(this, "id", "absorbers");
    __privateAdd(this, _instancesManager2);
    __privateSet(this, _instancesManager2, instancesManager);
  }
  async getPlugin(container) {
    const { AbsorbersPluginInstance } = await import("./AbsorbersPluginInstance-B3RAQC3B.js");
    return new AbsorbersPluginInstance(container, __privateGet(this, _instancesManager2));
  }
  loadOptions(_container15, options, source) {
...
_instancesManager2 = new WeakMap();
...
var Explode = class {
  constructor() {
    __publicField(this, "maxSizeFactor", 3);
...
var SplitRate = class extends ValueWithRandom {
  constructor() {
    super(...arguments);
    __publicField(this, "value", { min: 4, max: 9 });
  }
};
...
var Split = class {
  constructor() {
    ...
    __publicField(this, "factor", new SplitFactor());
    __publicField(this, "fillColor");
    __publicField(this, "fillColorOffset");
    __publicField(this, "particles");
    __publicField(this, "rate", new SplitRate());
    __publicField(this, "sizeOffset", true);
...
var Destroy = class {
  constructor() {
    __publicField(this, "bounds", new DestroyBounds());
    __publicField(this, "explode", new Explode());
    __publicField(this, "mode", DestroyMode.none);
    __publicField(this, "split", new Split());
  }
  load(data) {
    if (isNull(data)) {
      return;
...
var _container, _pluginManager2;
var DestroyUpdater = class {
  ...
  init(particle) {
    const container = __privateGet(this, _container), particlesOptions = particle.options, destroyOptions = particlesOptions.destroy;
    if (!destroyOptions) {
      return;
    }
  ...
  particleDestroyed(particle, override) {
    ...
    switch (destroyOptions == null ? void 0 : destroyOptions.mode) {
      case DestroyMode.split:
        split(__privateGet(this, _pluginManager2), __privateGet(this, _container), particle);
        break;
...
var _instancesManager3;
var EmittersInteractor = class extends ExternalInteractorBase {
  constructor(instancesManager, container) {
    super(container);
    __publicField(this, "handleClickMode");
    __publicField(this, "maxDistance");
    __privateAdd(this, _instancesManager3);
    __privateSet(this, _instancesManager3, instancesManager);
    this.maxDistance = 0;
    this.handleClickMode = (mode, interactivityData) => {
      ...
      void executeOnSingleOrMultiple(emittersOptions, async (emitter) => {
        await __privateGet(this, _instancesManager3).addEmitter(this.container, emitter, ePosition);
      });
    };
  }
  clear() {
  ...
  interact(_interactivityData, delta) {
    for (const emitter of __privateGet(this, _instancesManager3).getArray(this.container)) {
  ...
  removeEmitter(emitter) {
    const index = __privateGet(this, _instancesManager3).getArray(this.container).indexOf(emitter), minIndex = 0, deleteCount = 1;
    if (index >= minIndex) {
      __privateGet(this, _instancesManager3).getArray(this.container).splice(index, deleteCount);
    }
  }
  reset() {
  }
};
_instancesManager3 = new WeakMap();

// node_modules/@tsparticles/plugin-emitters/browser/addEmittersShapesManager.js
async function addEmittersShapesManager(e) {
  const { ShapeManager } = await import("./ShapeManager-AWWETNPA.js"), pluginManager = e.pluginManager;
...
function getEmittersInstancesManager(e) {
  ...
  if (!manager) {
    manager = import("./EmittersInstancesManager-XFIMYUER.js").then(({ EmittersInstancesManager }) => new EmittersInstancesManager(pluginManager)).catch((error) => {
...
var _instancesManager4;
var EmittersPlugin = class {
  constructor(instancesManager) {
    __publicField(this, "id", "emitters");
    __privateAdd(this, _instancesManager4);
    __privateSet(this, _instancesManager4, instancesManager);
  }
  async getPlugin(container) {
    const { EmittersPluginInstance } = await import("./EmittersPluginInstance-FEHH4E2O.js");
    return new EmittersPluginInstance(__privateGet(this, _instancesManager4), container);
  }
  loadOptions(_container15, options, source) {
    if (!this.needsPlugin(options) && !this.needsPlugin(source)) {
      return;
...
_instancesManager4 = new WeakMap();
...
var EmittersCircleShapeGenerator = class {
  generate(_container15, position, size, fill, options) {
...
var Drag = class {
  constructor() {
    __publicField(this, "momentumFactor", defaultMomentumFactor);
    __publicField(this, "preserveMomentum", defaultPreserveMomentum);
  }
  load(data) {
    if (isNull(data)) {
      return;
...
var zeroValue = 0;
var _dragStartClickTime, _dragStartClickingFalseTime, _draggedParticle, _grabOffset, _lastMousePosition, _momentumSamples, _mouseDownHandled, _savedVelocity, _Dragger_instances, findParticleUnderCursor_fn, hasClickEnded_fn, releaseDragged_fn;
var Dragger = class extends ExternalInteractorBase {
  constructor(container) {
    super(container);
    __privateAdd(this, _Dragger_instances);
    __publicField(this, "maxDistance", 0);
    __privateAdd(this, _dragStartClickTime);
    __privateAdd(this, _dragStartClickingFalseTime);
    __privateAdd(this, _draggedParticle);
    __privateAdd(this, _grabOffset);
    __privateAdd(this, _lastMousePosition);
    __privateAdd(this, _momentumSamples, []);
    __privateAdd(this, _mouseDownHandled, false);
    __privateAdd(this, _savedVelocity);
  }
  ...
  interact(interactivityData, _delta) {
    ...
    if (mousePos) {
      __privateSet(this, _lastMousePosition, mousePos);
    }
    if (__privateGet(this, _draggedParticle)) {
      const now = performance.now();
      if (!mouse.clicking) {
        __privateGet(this, _dragStartClickingFalseTime) ?? __privateSet(this, _dragStartClickingFalseTime, now);
      } else {
        __privateSet(this, _dragStartClickingFalseTime, void 0);
      }
      const hasStableClickEndWithoutClickTime = __privateGet(this, _dragStartClickTime) === void 0 && __privateGet(this, _dragStartClickingFalseTime) !== void 0 && now - __privateGet(this, _dragStartClickingFalseTime) >= clickReleaseDelayMs;
      if (!mouse.inside || __privateMethod(this, _Dragger_instances, hasClickEnded_fn).call(this, mouse) || hasStableClickEndWithoutClickTime) {
        __privateMethod(this, _Dragger_instances, releaseDragged_fn).call(this);
        __privateSet(this, _mouseDownHandled, false);
        return;
      }
      const pointerPos = mousePos ?? __privateGet(this, _lastMousePosition);
      if (!pointerPos) {
        return;
      }
      __privateGet(this, _momentumSamples).push({ x: pointerPos.x, y: pointerPos.y, t: now });
      if (__privateGet(this, _momentumSamples).length > maxMomentumSamples) {
        __privateGet(this, _momentumSamples).shift();
      }
      const targetX = pointerPos.x + (((_a = __privateGet(this, _grabOffset)) == null ? void 0 : _a.x) ?? zeroValue), targetY = pointerPos.y + (((_b = __privateGet(this, _grabOffset)) == null ? void 0 : _b.y) ?? zeroValue);
      __privateGet(this, _draggedParticle).position.x = targetX - __privateGet(this, _draggedParticle).offset.x;
      __privateGet(this, _draggedParticle).position.y = targetY - __privateGet(this, _draggedParticle).offset.y;
      __privateGet(this, _draggedParticle).velocity.x = zeroValue;
      __privateGet(this, _draggedParticle).velocity.y = zeroValue;
      __privateGet(this, _draggedParticle).initialPosition.x = __privateGet(this, _draggedParticle).position.x;
      __privateGet(this, _draggedParticle).initialPosition.y = __privateGet(this, _draggedParticle).position.y;
      __privateGet(this, _draggedParticle).misplaced = false;
      return;
    }
    if (!mouse.clicking) {
      __privateMethod(this, _Dragger_instances, releaseDragged_fn).call(this);
    ...
    if (__privateGet(this, _mouseDownHandled)) {
      return;
    }
    __privateSet(this, _mouseDownHandled, true);
    const downPos = mouse.downPosition ?? mousePos ?? __privateGet(this, _lastMousePosition), closest = __privateMethod(this, _Dragger_instances, findParticleUnderCursor_fn).call(this, interactivityData, downPos);
    if (!closest || !mousePos) {
      if (!closest) {
        __privateSet(this, _mouseDownHandled, false);
      }
    ...
    __privateSet(this, _draggedParticle, closest);
    __privateSet(this, _dragStartClickTime, mouse.clickTime);
    __privateSet(this, _grabOffset, {
      x: renderedPos.x - mousePos.x,
      y: renderedPos.y - mousePos.y
    });
    __privateSet(this, _savedVelocity, { x: closest.velocity.x, y: closest.velocity.y });
    __privateSet(this, _dragStartClickingFalseTime, void 0);
    __privateSet(this, _momentumSamples, [{ x: mousePos.x, y: mousePos.y, t: performance.now() }]);
  ...
  isEnabled(interactivityData, particle) {
    ...
    if (__privateGet(this, _draggedParticle) || __privateGet(this, _mouseDownHandled)) {
      return true;
    }
...
_dragStartClickTime = new WeakMap();
_dragStartClickingFalseTime = new WeakMap();
_draggedParticle = new WeakMap();
_grabOffset = new WeakMap();
_lastMousePosition = new WeakMap();
_momentumSamples = new WeakMap();
_mouseDownHandled = new WeakMap();
_savedVelocity = new WeakMap();
_Dragger_instances = new WeakSet();
findParticleUnderCursor_fn = function(interactivityData, mousePos) {
  if (!mousePos) {
    return;
  }
...
hasClickEnded_fn = function(mouse) {
  return __privateGet(this, _dragStartClickTime) !== void 0 && mouse.clickTime !== void 0 && mouse.clickTime !== __privateGet(this, _dragStartClickTime);
};
releaseDragged_fn = function() {
  var _a;
  if (__privateGet(this, _draggedParticle)) {
    ...
    if (preserveMomentum && __privateGet(this, _momentumSamples).length >= minSamplesForMomentum) {
      const first = __privateGet(this, _momentumSamples)[firstSampleIndex], last = __privateGet(this, _momentumSamples)[__privateGet(this, _momentumSamples).length - lastSampleOffset];
      if (first && last) {
        const dt = last.t - first.t;
        if (dt > zeroValue) {
          const factor = (dragOptions == null ? void 0 : dragOptions.momentumFactor) ?? defaultMomentumFactor2;
          __privateGet(this, _draggedParticle).velocity.x = (last.x - first.x) / dt * momentumToVelocityFactor * factor;
          __privateGet(this, _draggedParticle).velocity.y = (last.y - first.y) / dt * momentumToVelocityFactor * factor;
        } else if (__privateGet(this, _savedVelocity)) {
          __privateGet(this, _draggedParticle).velocity.x = __privateGet(this, _savedVelocity).x;
          __privateGet(this, _draggedParticle).velocity.y = __privateGet(this, _savedVelocity).y;
        }
      } else if (__privateGet(this, _savedVelocity)) {
        __privateGet(this, _draggedParticle).velocity.x = __privateGet(this, _savedVelocity).x;
        __privateGet(this, _draggedParticle).velocity.y = __privateGet(this, _savedVelocity).y;
  ...
  __privateSet(this, _draggedParticle, void 0);
  __privateSet(this, _dragStartClickTime, void 0);
  __privateSet(this, _dragStartClickingFalseTime, void 0);
  __privateSet(this, _grabOffset, void 0);
  __privateSet(this, _lastMousePosition, void 0);
  __privateSet(this, _momentumSamples, []);
  __privateSet(this, _savedVelocity, void 0);
};
...
var TrailColorComponent = class {
  constructor() {
    ...
    __publicField(this, "weights", new TrailColorWeight());
  }
  load(data) {
    if (!data) {
      return;
...
var TrailColorCoords = class {
  constructor() {
    __publicField(this, "h", new TrailColorComponent());
    __publicField(this, "l", new TrailColorComponent());
    __publicField(this, "s", new TrailColorComponent());
  }
  load(data) {
    if (!data) {
      return;
...
var Trail = class {
  constructor() {
    __publicField(this, "colorCoords", new TrailColorCoords());
    __publicField(this, "delay", 1);
    __publicField(this, "particles");
    __publicField(this, "pauseOnStop", false);
    __publicField(this, "quantity", 1);
  }
  load(data) {
    if (isNull(data))
      return;
...
var TrailMaker = class extends ExternalInteractorBase {
  ...
  interact(interactivityData, delta) {
    ...
    if (__privateGet(this, _delay) < optDelay) {
      __privateSet(this, _delay, __privateGet(this, _delay) + delta.value);
    }
    if (__privateGet(this, _delay) < optDelay)
      return;
    const mousePos = interactivityData.mouse.position, canEmit = !(trailOptions.pauseOnStop && (mousePos === __privateGet(this, _lastPosition) || (mousePos == null ? void 0 : mousePos.x) === ((_b = __privateGet(this, _lastPosition)) == null ? void 0 : _b.x) && (mousePos == null ? void 0 : mousePos.y) === ((_c = __privateGet(this, _lastPosition)) == null ? void 0 : _c.y)));
    if (mousePos) {
      __privateSet(this, _lastPosition, { ...mousePos });
    } else {
      __privateSet(this, _lastPosition, void 0);
    }
    if (canEmit && mousePos) {
    ...
    __privateSet(this, _delay, __privateGet(this, _delay) - optDelay);
  }
  isEnabled(interactivityData, particle) {
    var _a;
...
var Roll = class {
  constructor() {
    ...
    __publicField(this, "darken", new RollLight());
    __publicField(this, "enable", false);
    __publicField(this, "enlighten", new RollLight());
    __publicField(this, "mode", RollMode.vertical);
...
var RollUpdater = class {
  ...
  init(particle) {
    initParticle(__privateGet(this, _pluginManager4), particle);
  }
  isEnabled(particle) {
...
var Blend = class {
  constructor() {
    __publicField(this, "enable", false);
    __publicField(this, "mode", "destination-out");
  }
  load(data) {
    if (isNull(data)) {
      return;
...
var BlendPlugin = class {
  ...
  async getPlugin(container) {
    const { BlendPluginInstance } = await import("./BlendPluginInstance-ESRUDWD7.js");
  ...
  loadParticlesOptions(_container15, options, source) {
...
var CircleDrawer = class {
  ...
  particleInit(_container15, particle) {
...
var defaultAlpha2 = 1;
var alphaFactor = 255;
var _HexColorManager_instances, parseString_fn;
var HexColorManager = class {
  constructor() {
    __privateAdd(this, _HexColorManager_instances);
  }
  accepts(input) {
    return input.startsWith("#");
  }
  handleColor(color) {
    return __privateMethod(this, _HexColorManager_instances, parseString_fn).call(this, color.value);
  }
  handleRangeColor(color) {
    return __privateMethod(this, _HexColorManager_instances, parseString_fn).call(this, color.value);
  }
  parseString(input) {
    return __privateMethod(this, _HexColorManager_instances, parseString_fn).call(this, input);
  }
};
_HexColorManager_instances = new WeakSet();
parseString_fn = function(hexColor) {
...
var MovePlugin = class {
  ...
  async getPlugin(container) {
    const { MovePluginInstance } = await import("./MovePluginInstance-EXNA2ETM.js");
    return new MovePluginInstance(__privateGet(this, _pluginManager5), container);
  }
  loadOptions() {
  }
  needsPlugin() {
  ...
  switch (data.status) {
    case AnimationStatus.increasing:
      if (data.value >= maxValue) {
        ...
        data.loops ?? (data.loops = minLoops2);
        data.loops++;
      }
      break;
    case AnimationStatus.decreasing:
...
var OpacityAnimation = class extends RangedAnimationOptions {
  constructor() {
    super(...arguments);
    __publicField(this, "destroy", DestroyType.none);
  }
  load(data) {
    super.load(data);
    if (isNull(data)) {
...
var Opacity = class extends RangedAnimationValueWithRandom {
  constructor() {
    super(...arguments);
    __publicField(this, "animation", new OpacityAnimation());
...
var OpacityUpdater = class {
  ...
  init(particle) {
    ...
    if (opacityAnimation.enable) {
      particle.opacity.velocity = getRangeValue(opacityAnimation.speed) / percentDenominator * __privateGet(this, _container2).retina.reduceFactor;
...
var _container3, _particleBouncePlugins;
var BounceOutMode = class {
  constructor(container) {
    __publicField(this, "modes");
    __privateAdd(this, _container3);
    __privateAdd(this, _particleBouncePlugins);
    __privateSet(this, _container3, container);
    this.modes = [
      OutMode.bounce,
      OutMode.split
    ];
    __privateSet(this, _particleBouncePlugins, container.plugins.filter((p) => p.particleBounce !== void 0));
  }
  update(particle, direction, delta, outMode) {
    ...
    const container = __privateGet(this, _container3);
    let handled = false;
    for (const plugin of __privateGet(this, _particleBouncePlugins)) {
...
var NoneOutMode = class {
  ...
  update(particle, direction, _delta, outMode) {
    ...
    const gravityOptions = particle.options.move.gravity, container = __privateGet(this, _container4), canvasSize = container.canvas.size, pRadius = particle.getRadius();
...
var _container6, _OutOfCanvasUpdater_instances, addUpdaterIfMissing_fn, updateOutMode_fn;
var OutOfCanvasUpdater = class {
  constructor(container) {
    __privateAdd(this, _OutOfCanvasUpdater_instances);
  ...
  init(particle) {
    __privateMethod(this, _OutOfCanvasUpdater_instances, addUpdaterIfMissing_fn).call(this, particle, OutMode.bounce, (container) => new BounceOutMode(container));
    __privateMethod(this, _OutOfCanvasUpdater_instances, addUpdaterIfMissing_fn).call(this, particle, OutMode.out, (container) => new OutOutMode(container));
    __privateMethod(this, _OutOfCanvasUpdater_instances, addUpdaterIfMissing_fn).call(this, particle, OutMode.destroy, (container) => new DestroyOutMode(container));
    __privateMethod(this, _OutOfCanvasUpdater_instances, addUpdaterIfMissing_fn).call(this, particle, OutMode.none, (container) => new NoneOutMode(container));
  }
  isEnabled(particle) {
  ...
  update(particle, delta) {
    ...
    __privateMethod(this, _OutOfCanvasUpdater_instances, updateOutMode_fn).call(this, particle, delta, outModes.bottom ?? outModes.default, OutModeDirection.bottom);
    __privateMethod(this, _OutOfCanvasUpdater_instances, updateOutMode_fn).call(this, particle, delta, outModes.left ?? outModes.default, OutModeDirection.left);
    __privateMethod(this, _OutOfCanvasUpdater_instances, updateOutMode_fn).call(this, particle, delta, outModes.right ?? outModes.default, OutModeDirection.right);
    __privateMethod(this, _OutOfCanvasUpdater_instances, updateOutMode_fn).call(this, particle, delta, outModes.top ?? outModes.default, OutModeDirection.top);
  }
};
_container6 = new WeakMap();
_OutOfCanvasUpdater_instances = new WeakSet();
addUpdaterIfMissing_fn = function(particle, outMode, getUpdater) {
  const outModes = particle.options.move.outModes;
  if (!this.updaters.has(outMode) && checkOutMode(outModes, outMode)) {
    this.updaters.set(outMode, getUpdater(__privateGet(this, _container6)));
  }
};
updateOutMode_fn = function(particle, delta, outMode, direction) {
...
var _container7, _pluginManager6;
var PaintUpdater = class {
  constructor(pluginManager, container) {
    __privateAdd(this, _container7);
    __privateAdd(this, _pluginManager6);
    __privateSet(this, _container7, container);
    __privateSet(this, _pluginManager6, pluginManager);
  }
  init(particle) {
    const container = __privateGet(this, _container7), options = particle.options, paint = itemFromSingleOrMultiple(options.paint, particle.id, options.reduceDuplicates), color = paint == null ? void 0 : paint.color, paintColor = color ?? void 0, fill = paint == null ? void 0 : paint.fill, stroke = paint == null ? void 0 : paint.stroke;
    if (fill) {
      ...
      const fillHslColor = rangeColorToHsl(__privateGet(this, _pluginManager6), fillColor);
      if (fillHslColor) {
    ...
    if (stroke) {
      ...
      const strokeHslColor = rangeColorToHsl(__privateGet(this, _pluginManager6), strokeColor) ?? particle.getFillColor();
      if (strokeHslColor) {
  ...
  update(particle, delta) {
    ...
    updateColor(particle.fillColor, delta, __privateGet(this, _container7).hdr);
    updateColor(particle.strokeColor, delta, __privateGet(this, _container7).hdr);
  }
};
_container7 = new WeakMap();
_pluginManager6 = new WeakMap();
...
var Size = class extends RangedAnimationValueWithRandom {
  constructor() {
    super(...arguments);
    __publicField(this, "animation", new SizeAnimation());
    __publicField(this, "value", 3);
  }
  load(data) {
    super.load(data);
...
var SizeUpdater = class {
  constructor(container) {
    ...
    __privateSet(this, _container8, container);
  }
  init(particle) {
    const container = __privateGet(this, _container8), sizeOptions = particle.options.size;
    if (!sizeOptions) {
      return;
    }
  ...
  preInit(particle) {
    const pxRatio = __privateGet(this, _container8).retina.pixelRatio, options = particle.options, sizeOptions = options.size;
    if (!sizeOptions) {
      return;
    }
...
var EmojiDrawer = class {
  constructor() {
    __privateAdd(this, _emojiShapeDict, /* @__PURE__ */ new Map());
  }
  destroy() {
    for (const [key, data] of __privateGet(this, _emojiShapeDict)) {
      if (data instanceof ImageBitmap) {
        data.close();
      }
      __privateGet(this, _emojiShapeDict).delete(key);
    }
  }
  draw(data) {
    ...
    const image = __privateGet(this, _emojiShapeDict).get(key);
    if (!image) {
      return;
    }
  ...
  particleInit(container, particle) {
    ...
    if (__privateGet(this, _emojiShapeDict).has(cacheKey)) {
    ...
    __privateGet(this, _emojiShapeDict).set(cacheKey, image);
    particle.emojiDataKey = cacheKey;
  }
};
_emojiShapeDict = new WeakMap();
...
var Attract = class {
  constructor() {
    __publicField(this, "distance", 200);
    __publicField(this, "duration", 0.4);
    __publicField(this, "easing", "ease-out-quad");
    __publicField(this, "factor", 1);
    __publicField(this, "maxSpeed", 50);
...
var _interactedThisFrame, _maxDistance, _pluginManager7, _restoreData, _Attractor_instances, restoreParticles_fn, trackInteractedParticle_fn;
var Attractor = class extends ExternalInteractorBase {
  constructor(pluginManager, container) {
    super(container);
    __privateAdd(this, _Attractor_instances);
    __publicField(this, "handleClickMode");
    __privateAdd(this, _interactedThisFrame);
    __privateAdd(this, _maxDistance);
    __privateAdd(this, _pluginManager7);
    __privateAdd(this, _restoreData);
    __privateSet(this, _pluginManager7, pluginManager);
    __privateSet(this, _maxDistance, 0);
    __privateSet(this, _interactedThisFrame, /* @__PURE__ */ new Set());
    __privateSet(this, _restoreData, /* @__PURE__ */ new Map());
    container.attract ?? (container.attract = { particles: [] });
    this.handleClickMode = (mode, interactivityData) => {
      var _a;
  ...
  init() {
    ...
    __privateSet(this, _maxDistance, attract.distance);
    container.retina.attractModeDistance = attract.distance * container.retina.pixelRatio;
  }
  interact(interactivityData) {
    var _a;
    __privateGet(this, _interactedThisFrame).clear();
    ...
    if (mouseMoveStatus && hoverEnabled && isInArray(attractMode, hoverMode)) {
      hoverAttract(__privateGet(this, _pluginManager7), this.container, interactivityData, (p) => this.isEnabled(interactivityData, p), (p) => {
        __privateMethod(this, _Attractor_instances, trackInteractedParticle_fn).call(this, p);
      });
    } else if (clickEnabled && isInArray(attractMode, clickMode)) {
      clickAttract(__privateGet(this, _pluginManager7), this.container, interactivityData, (p) => this.isEnabled(interactivityData, p), (p) => {
        __privateMethod(this, _Attractor_instances, trackInteractedParticle_fn).call(this, p);
      });
    }
    __privateMethod(this, _Attractor_instances, restoreParticles_fn).call(this);
  }
  isEnabled(interactivityData, particle) {
    var _a;
    const container = this.container, options = container.actualOptions, mouse = interactivityData.mouse, events = (_a = (particle == null ? void 0 : particle.interactivity) ?? options.interactivity) == null ? void 0 : _a.events;
...
_interactedThisFrame = new WeakMap();
_maxDistance = new WeakMap();
_pluginManager7 = new WeakMap();
_restoreData = new WeakMap();
_Attractor_instances = new WeakSet();
restoreParticles_fn = function() {
  var _a, _b;
  const restore = (_b = (_a = this.container.actualOptions.interactivity) == null ? void 0 : _a.modes.attract) == null ? void 0 : _b.restore;
  if (!(restore == null ? void 0 : restore.enable) || !__privateGet(this, _restoreData).size) {
    return;
  }
  ...
  for (const [particle, restoreData] of __privateGet(this, _restoreData)) {
    if (__privateGet(this, _interactedThisFrame).has(particle)) {
      continue;
    }
    if (particle.destroyed) {
      __privateGet(this, _restoreData).delete(particle);
      continue;
    }
...
trackInteractedParticle_fn = function(particle) {
  var _a, _b;
  __privateGet(this, _interactedThisFrame).add(particle);
  const restore = (_b = (_a = this.container.actualOptions.interactivity) == null ? void 0 : _a.modes.attract) == null ? void 0 : _b.restore;
  if (!(restore == null ? void 0 : restore.enable)) {
    return;
  }
  const now = Date.now();
  let restoreData = __privateGet(this, _restoreData).get(particle);
  if (!restoreData) {
    restoreData = {
      target: particle.position.copy(),
      lastInteractionTime: now
    };
    __privateGet(this, _restoreData).set(particle, restoreData);
  }
...
var Bouncer = class extends ExternalInteractorBase {
  constructor(container) {
    super(container);
    __privateAdd(this, _maxDistance2);
    __privateSet(this, _maxDistance2, 0);
  }
  get maxDistance() {
    return __privateGet(this, _maxDistance2);
  }
  clear() {
  }
  init() {
    ...
    __privateSet(this, _maxDistance2, bounce2.distance);
...
var BubbleModifier = class {
  constructor() {
    ...
    __publicField(this, "fillColor");
    __publicField(this, "finalColor");
    __publicField(this, "id", "bubble");
    __publicField(this, "inRange", false);
    __publicField(this, "opacity");
...
var minRatio = 0;
var defaultRatio2 = 1;
var _maxDistance3, _modifiers, _pluginManager8, _Bubbler_instances, clickBubble_fn, hoverBubble_fn, hoverBubbleColor_fn, hoverBubbleOpacity_fn, hoverBubbleSize_fn, process_fn, singleSelectorHover_fn;
var Bubbler = class extends ExternalInteractorBase {
  constructor(pluginManager, container) {
    super(container);
    __privateAdd(this, _Bubbler_instances);
    __publicField(this, "handleClickMode");
    __privateAdd(this, _maxDistance3);
    __privateAdd(this, _modifiers, /* @__PURE__ */ new WeakMap());
    __privateAdd(this, _pluginManager8);
    __privateSet(this, _pluginManager8, pluginManager);
    __privateSet(this, _maxDistance3, 0);
  ...
  get maxDistance() {
    return __privateGet(this, _maxDistance3);
  }
  clear(particle, _delta, force) {
    const mod = __privateGet(this, _modifiers).get(particle);
    if ((mod == null ? void 0 : mod.inRange) && !force) {
      return;
    }
    particle.removeModifier(bubbleMode);
    __privateGet(this, _modifiers).delete(particle);
  }
  getOrCreateModifier(particle) {
    let mod = __privateGet(this, _modifiers).get(particle);
    if (!mod) {
      mod = new BubbleModifier();
      __privateGet(this, _modifiers).set(particle, mod);
  ...
  init() {
    ...
    __privateSet(this, _maxDistance3, bubble.distance);
  ...
  interact(interactivityData, delta) {
    ...
    if (hoverEnabled && isInArray(bubbleMode, hoverMode)) {
      __privateMethod(this, _Bubbler_instances, hoverBubble_fn).call(this, interactivityData);
    } else if (clickEnabled && isInArray(bubbleMode, clickMode)) {
      __privateMethod(this, _Bubbler_instances, clickBubble_fn).call(this, interactivityData);
    } else {
      divModeExecute(bubbleMode, divs, (selector, div) => {
        __privateMethod(this, _Bubbler_instances, singleSelectorHover_fn).call(this, interactivityData, delta, selector, div);
      });
    }
  }
  isEnabled(interactivityData, particle) {
...
_maxDistance3 = new WeakMap();
_modifiers = new WeakMap();
_pluginManager8 = new WeakMap();
_Bubbler_instances = new WeakSet();
clickBubble_fn = function(interactivityData) {
  var _a, _b, _c;
  ...
  for (const particle of query) {
    ...
    __privateMethod(this, _Bubbler_instances, process_fn).call(this, particle, distMouse, timeSpent, sizeData);
    const opacityData = {
      bubbleObj: {
      ...
      particlesObj: {
        optValue: ((_b = particle.opacity) == null ? void 0 : _b.max) ?? defaultOpacity2,
        value: ((_c = particle.opacity) == null ? void 0 : _c.value) ?? defaultOpacity2
      },
      type: ProcessBubbleType.opacity
    };
    __privateMethod(this, _Bubbler_instances, process_fn).call(this, particle, distMouse, timeSpent, opacityData);
    if (!bubble.durationEnd && distMouse <= distance) {
      __privateMethod(this, _Bubbler_instances, hoverBubbleColor_fn).call(this, particle, distMouse);
    } else {
...
hoverBubble_fn = function(interactivityData) {
  ...
  for (const particle of query) {
    ...
    if (pointDistance <= distance) {
      if (ratio >= minRatio && interactivityData.status === mouseMoveEvent) {
        __privateMethod(this, _Bubbler_instances, hoverBubbleSize_fn).call(this, particle, ratio);
        __privateMethod(this, _Bubbler_instances, hoverBubbleOpacity_fn).call(this, particle, ratio);
        __privateMethod(this, _Bubbler_instances, hoverBubbleColor_fn).call(this, particle, ratio);
      }
    } else {
...
hoverBubbleColor_fn = function(particle, ratio, divBubble) {
  var _a;
  const options = this.container.actualOptions, bubbleOptions = divBubble ?? ((_a = options.interactivity) == null ? void 0 : _a.modes.bubble), mod = this.getOrCreateModifier(particle);
  if (!bubbleOptions) {
    return;
  }
  if (!mod.finalColor) {
    ...
    mod.finalColor = rangeColorToHsl(__privateGet(this, _pluginManager8), bubbleColor);
  }
  if (!mod.finalColor) {
    return;
  }
...
hoverBubbleOpacity_fn = function(particle, ratio, divBubble) {
  var _a, _b, _c, _d;
  ...
  const pOpacity = ((_c = particle.opacity) == null ? void 0 : _c.value) ?? defaultOpacity2, opacity = calculateBubbleValue(pOpacity, modeOpacity, ((_d = particle.opacity) == null ? void 0 : _d.max) ?? defaultOpacity2, ratio);
  if (opacity !== void 0) {
    const mod = this.getOrCreateModifier(particle);
    mod.opacity = opacity;
  }
};
hoverBubbleSize_fn = function(particle, ratio, divBubble) {
...
process_fn = function(particle, distMouse, timeSpent, data) {
  var _a;
...
singleSelectorHover_fn = function(interactivityData, delta, selector, div) {
  var _a;
  ...
  selectors.forEach((item) => {
    ...
    for (const particle of query) {
      ...
      __privateMethod(this, _Bubbler_instances, hoverBubbleSize_fn).call(this, particle, defaultRatio2, divBubble);
      __privateMethod(this, _Bubbler_instances, hoverBubbleOpacity_fn).call(this, particle, defaultRatio2, divBubble);
      __privateMethod(this, _Bubbler_instances, hoverBubbleColor_fn).call(this, particle, defaultRatio2, divBubble);
    }
  });
};
...
var Connect = class {
  constructor() {
    __publicField(this, "distance", 80);
    __publicField(this, "links", new ConnectLinks());
    __publicField(this, "radius", 60);
  }
  load(data) {
    if (isNull(data)) {
      return;
...
var Connector = class extends ExternalInteractorBase {
  constructor(container) {
    super(container);
    __privateAdd(this, _maxDistance4);
    __privateSet(this, _maxDistance4, 0);
  }
  get maxDistance() {
    return __privateGet(this, _maxDistance4);
  }
  clear() {
  }
  init() {
    ...
    __privateSet(this, _maxDistance4, connect.distance);
...
var Destroyer = class extends ExternalInteractorBase {
  constructor(container) {
    super(container);
    __privateAdd(this, _maxDistance5);
    __privateSet(this, _maxDistance5, 0);
  }
  get maxDistance() {
    return __privateGet(this, _maxDistance5);
  }
  clear() {
  }
  init() {
    ...
    __privateSet(this, _maxDistance5, destroy2.distance);
...
var GrabLinks = class {
  constructor() {
    __publicField(this, "blink", false);
    __publicField(this, "color");
    __publicField(this, "consent", false);
...
var Grab = class {
  constructor() {
    __publicField(this, "distance", 100);
    __publicField(this, "links", new GrabLinks());
  }
  load(data) {
    if (isNull(data)) {
      return;
...
var minDistance4 = 0;
var minOpacity = 0;
var _maxDistance6, _pluginManager9;
var Grabber = class extends ExternalInteractorBase {
  constructor(pluginManager, container) {
    super(container);
    __privateAdd(this, _maxDistance6);
    __privateAdd(this, _pluginManager9);
    __privateSet(this, _pluginManager9, pluginManager);
    __privateSet(this, _maxDistance6, 0);
  }
  get maxDistance() {
    return __privateGet(this, _maxDistance6);
  }
  clear() {
  }
  init() {
    ...
    __privateSet(this, _maxDistance6, grab.distance);
  ...
  interact(interactivityData) {
    ...
    for (const particle of query) {
      ...
      if (!container.particles.grabLineColor && optColor) {
        ...
        container.particles.grabLineColor = getLinkRandomColor(__privateGet(this, _pluginManager9), optColor, linksOptions.blink, linksOptions.consent);
      }
...
_maxDistance6 = new WeakMap();
_pluginManager9 = new WeakMap();
...
var Parallax = class {
  constructor() {
    __publicField(this, "force", 2);
    __publicField(this, "smooth", 10);
  }
  load(data) {
    if (isNull(data)) {
      return;
...
var _Parallaxer_instances, parallaxInteract_fn;
var Parallaxer = class extends ExternalInteractorBase {
  constructor(container) {
    super(container);
    __privateAdd(this, _Parallaxer_instances);
    __publicField(this, "maxDistance", 0);
  }
  clear() {
  }
  ...
  interact(interactivityData) {
    for (const particle of this.container.particles.filter((p) => this.isEnabled(interactivityData, p))) {
      __privateMethod(this, _Parallaxer_instances, parallaxInteract_fn).call(this, interactivityData, particle);
    }
  }
  isEnabled(interactivityData, particle) {
    var _a;
...
_Parallaxer_instances = new WeakSet();
parallaxInteract_fn = function(interactivityData, particle) {
  var _a;
  if (!this.isEnabled(interactivityData, particle)) {
    return;
  }
...
var Push = class {
  constructor() {
    __publicField(this, "default", true);
    __publicField(this, "groups", []);
    __publicField(this, "particles");
    __publicField(this, "quantity", 4);
  }
  load(data) {
    if (isNull(data)) {
      return;
...
var _clickVec, _interactedThisFrame2, _maxDistance7, _normVec, _pluginManager10, _restoreData2, _Repulser_instances, clickRepulse_fn, hoverRepulse_fn, processRepulse_fn, restoreParticles_fn2, singleSelectorRepulse_fn, trackInteractedParticle_fn2;
var Repulser = class extends ExternalInteractorBase {
  constructor(pluginManager, container) {
    super(container);
    __privateAdd(this, _Repulser_instances);
    __publicField(this, "handleClickMode");
    __privateAdd(this, _clickVec);
    __privateAdd(this, _interactedThisFrame2);
    __privateAdd(this, _maxDistance7);
    __privateAdd(this, _normVec);
    __privateAdd(this, _pluginManager10);
    __privateAdd(this, _restoreData2);
    __privateSet(this, _pluginManager10, pluginManager);
    __privateSet(this, _maxDistance7, 0);
    __privateSet(this, _normVec, Vector.origin);
    __privateSet(this, _interactedThisFrame2, /* @__PURE__ */ new Set());
    __privateSet(this, _clickVec, Vector.origin);
    __privateSet(this, _restoreData2, /* @__PURE__ */ new Map());
  ...
  get maxDistance() {
    return __privateGet(this, _maxDistance7);
  }
  clear() {
  }
  init() {
    ...
    __privateSet(this, _maxDistance7, repulse.distance);
    container.retina.repulseModeDistance = repulse.distance * container.retina.pixelRatio;
  }
  interact(interactivityData) {
    var _a;
    __privateGet(this, _interactedThisFrame2).clear();
    const container = this.container, options = container.actualOptions, mouseMoveStatus = interactivityData.status === mouseMoveEvent, events = (_a = options.interactivity) == null ? void 0 : _a.events;
    if (!events) {
      return;
    }
    ...
    if (mouseMoveStatus && hoverEnabled && isInArray(repulseMode, hoverMode)) {
      __privateMethod(this, _Repulser_instances, hoverRepulse_fn).call(this, interactivityData);
    } else if (clickEnabled && isInArray(repulseMode, clickMode)) {
      __privateMethod(this, _Repulser_instances, clickRepulse_fn).call(this, interactivityData);
    } else {
      divModeExecute(repulseMode, divs, (selector, div) => {
        __privateMethod(this, _Repulser_instances, singleSelectorRepulse_fn).call(this, interactivityData, selector, div);
      });
    }
    __privateMethod(this, _Repulser_instances, restoreParticles_fn2).call(this);
  }
  isEnabled(interactivityData, particle) {
    var _a;
    const container = this.container, options = container.actualOptions, mouse = interactivityData.mouse, events = (_a = (particle == null ? void 0 : particle.interactivity) ?? options.interactivity) == null ? void 0 : _a.events;
...
_clickVec = new WeakMap();
_interactedThisFrame2 = new WeakMap();
_maxDistance7 = new WeakMap();
_normVec = new WeakMap();
_pluginManager10 = new WeakMap();
_restoreData2 = new WeakMap();
_Repulser_instances = new WeakSet();
clickRepulse_fn = function(interactivityData) {
  var _a;
  ...
  if (repulse.clicking) {
    ...
    for (const particle of query) {
      ...
      if (d <= repulseRadius) {
        __privateMethod(this, _Repulser_instances, trackInteractedParticle_fn2).call(this, particle);
        repulse.particles.push(particle);
        __privateGet(this, _clickVec).x = dx;
        __privateGet(this, _clickVec).y = dy;
        __privateGet(this, _clickVec).length = force;
        particle.velocity.setTo(__privateGet(this, _clickVec));
      }
    }
...
hoverRepulse_fn = function(interactivityData) {
  ...
  __privateMethod(this, _Repulser_instances, processRepulse_fn).call(this, interactivityData, mousePos, repulseRadius, new Circle(mousePos.x, mousePos.y, repulseRadius));
};
processRepulse_fn = function(interactivityData, position, repulseRadius, area, divRepulse) {
  var _a;
  ...
  const { easing, speed, factor, maxSpeed } = repulseOptions, easingFunc = __privateGet(this, _pluginManager10).getEasing(easing), velocity = ((divRepulse == null ? void 0 : divRepulse.speed) ?? speed) * factor;
  for (const particle of query) {
    ...
    __privateGet(this, _normVec).x = !distance ? velocity : dx / distance * repulseFactor;
    __privateGet(this, _normVec).y = !distance ? velocity : dy / distance * repulseFactor;
    __privateMethod(this, _Repulser_instances, trackInteractedParticle_fn2).call(this, particle);
    particle.position.addTo(__privateGet(this, _normVec));
  }
};
restoreParticles_fn2 = function() {
  var _a, _b;
  const restore = (_b = (_a = this.container.actualOptions.interactivity) == null ? void 0 : _a.modes.repulse) == null ? void 0 : _b.restore;
  if (!(restore == null ? void 0 : restore.enable) || !__privateGet(this, _restoreData2).size) {
    return;
  }
  ...
  for (const [particle, restoreData] of __privateGet(this, _restoreData2)) {
    if (__privateGet(this, _interactedThisFrame2).has(particle)) {
      continue;
    }
    if (particle.destroyed) {
      __privateGet(this, _restoreData2).delete(particle);
      continue;
    }
    const target = restoreData.target;
    if (now - restoreData.lastInteractionTime < restoreDelay) {
...
singleSelectorRepulse_fn = function(interactivityData, selector, div) {
  var _a;
  const container = this.container, repulse = (_a = container.actualOptions.interactivity) == null ? void 0 : _a.modes.repulse;
  if (!repulse) {
    return;
  ...
  query.forEach((item) => {
    ...
    __privateMethod(this, _Repulser_instances, processRepulse_fn).call(this, interactivityData, pos, repulseRadius, area, divRepulse);
  });
};
trackInteractedParticle_fn2 = function(particle) {
  var _a, _b;
  __privateGet(this, _interactedThisFrame2).add(particle);
  const restore = (_b = (_a = this.container.actualOptions.interactivity) == null ? void 0 : _a.modes.repulse) == null ? void 0 : _b.restore;
  if (!(restore == null ? void 0 : restore.enable)) {
    return;
  }
  const now = Date.now();
  let restoreData = __privateGet(this, _restoreData2).get(particle);
  if (!restoreData) {
    restoreData = {
      target: particle.position.copy(),
      lastInteractionTime: now
    };
    __privateGet(this, _restoreData2).set(particle, restoreData);
  }
  restoreData.lastInteractionTime = now;
  if (restore.follow && particle.options.move.enable) {
...
var Slow = class {
  constructor() {
    __publicField(this, "factor", 3);
    __publicField(this, "radius", 200);
  }
  load(data) {
    if (isNull(data)) {
      return;
...
var SlowModifier = class {
  constructor() {
    __publicField(this, "enabled", false);
    __publicField(this, "id", "slow");
    __publicField(this, "priority", 100);
    __publicField(this, "speedFactor", 1);
  }
};
...
var slowMode = "slow";
var minRadius4 = 0;
var _maxDistance8, _modifiers2;
var Slower = class extends ExternalInteractorBase {
  constructor(container) {
    super(container);
    __privateAdd(this, _maxDistance8);
    __privateAdd(this, _modifiers2, /* @__PURE__ */ new WeakMap());
    __privateSet(this, _maxDistance8, 0);
  }
  get maxDistance() {
    return __privateGet(this, _maxDistance8);
  }
  clear(particle, _delta, force) {
    const mod = __privateGet(this, _modifiers2).get(particle);
    if ((mod == null ? void 0 : mod.enabled) && !force) {
      return;
    }
    particle.removeModifier(slowMode);
    __privateGet(this, _modifiers2).delete(particle);
  }
  getOrCreateModifier(particle) {
    let mod = __privateGet(this, _modifiers2).get(particle);
    if (!mod) {
      mod = new SlowModifier();
      __privateGet(this, _modifiers2).set(particle, mod);
      particle.addModifier(mod);
    }
    return mod;
  }
  init() {
    ...
    __privateSet(this, _maxDistance8, slow.radius);
...
var sides3 = 12;
var _container9, _engine, _loadImageShape;
var ImageDrawer = class {
  constructor(engine, container) {
    __privateAdd(this, _container9);
    __privateAdd(this, _engine);
    __privateAdd(this, _loadImageShape, async (container, imageShape) => {
      if (!__privateGet(this, _engine).loadImage) {
        throw new Error(`Image shape not initialized`);
      }
      await __privateGet(this, _engine).loadImage(container, {
    ...
    __privateSet(this, _container9, container);
  }
  draw(data) {
  ...
  async init(container) {
    ...
    if (!options.preload || !__privateGet(this, _engine).loadImage) {
      return;
    }
    const promises = [];
    for (const imageData of options.preload) {
      promises.push(__privateGet(this, _engine).loadImage(container, imageData));
    }
    await Promise.all(promises);
  }
  loadShape(particle) {
    var _a, _b;
    const container = __privateGet(this, _container9);
    ...
    const images = (_b = (_a = __privateGet(this, _engine)).getImages) == null ? void 0 : _b.call(_a, container), image = images == null ? void 0 : images.find((t) => t.name === imageData.name || t.source === imageData.src);
    if (image) {
      return;
    }
    void __privateGet(this, _loadImageShape).call(this, container, imageData).then(() => {
  ...
  particleInit(container, particle) {
    ...
    const images = (_b = (_a = __privateGet(this, _engine)).getImages) == null ? void 0 : _b.call(_a, container), imageData = particle.shapeData;
    if (!imageData) {
      return;
    }
...
var ImagePreloaderPlugin = class {
  constructor(engine) {
    ...
    __privateAdd(this, _engine2);
    __privateSet(this, _engine2, engine);
  }
  async getPlugin(container) {
    const { ImagePreloaderInstance } = await import("./ImagePreloaderInstance-CNLTRBGG.js");
    return new ImagePreloaderInstance(__privateGet(this, _engine2), container);
  }
  loadOptions(_container15, options, source) {
...
var Life = class {
  constructor() {
    ...
    __publicField(this, "delay", new LifeDelay());
    __publicField(this, "duration", new LifeDuration());
  }
  load(data) {
    if (isNull(data)) {
      return;
...
var LifeUpdater = class {
  constructor(container) {
    ...
    __privateSet(this, _container10, container);
  }
  init(particle) {
    const container = __privateGet(this, _container10), particlesOptions = particle.options, lifeOptions = particlesOptions.life;
    if (!lifeOptions) {
      return;
    }
  ...
  update(particle, delta) {
    ...
    updateLife(particle, delta, __privateGet(this, _container10).canvas.size);
  }
};
...
var Attractor2 = class extends ParticlesInteractorBase {
  constructor(container) {
    super(container);
    __privateAdd(this, _maxDistance9);
    __privateSet(this, _maxDistance9, 0);
  }
  get maxDistance() {
    return __privateGet(this, _maxDistance9);
  }
  clear() {
  }
  init() {
  ...
  interact(p1) {
    ...
    if (isNull(p1.attractDistance)) {
      ...
      if (attractDistance > __privateGet(this, _maxDistance9)) {
        __privateSet(this, _maxDistance9, attractDistance);
      }
...
var Collisions = class {
  constructor() {
    __publicField(this, "absorb", new CollisionsAbsorb());
    __publicField(this, "bounce", new ParticlesBounce());
    __publicField(this, "enable", false);
    __publicField(this, "maxSpeed", 50);
    __publicField(this, "mode", CollisionMode.bounce);
    __publicField(this, "overlap", new CollisionsOverlap());
  }
  load(data) {
    if (isNull(data)) {
      return;
...
var OverlapPlugin = class {
  ...
  async getPlugin(container) {
    const { OverlapPluginInstance } = await import("./OverlapPluginInstance-JVEHVFFS.js");
...
var CircleWarp = class extends Circle {
  constructor(x, y, radius, canvasSize) {
    super(x, y, radius);
    __privateAdd(this, _canvasSize);
    __privateSet(this, _canvasSize, canvasSize);
  }
  contains(point) {
    if (super.contains(point))
      return true;
    const { width, height } = __privateGet(this, _canvasSize), { x, y } = point;
  ...
  intersects(range) {
    if (super.intersects(range))
      return true;
    const { width, height } = __privateGet(this, _canvasSize), pos = range.position, shifts = [
      { x: -width, y: 0 },
      { x: width, y: 0 },
      { x: 0, y: -height },
      { x: 0, y: height },
...
var LinksTriangle = class {
  constructor() {
    __publicField(this, "color");
    __publicField(this, "enable", false);
    __publicField(this, "frequency", 1);
    __publicField(this, "opacity");
  }
  load(data) {
    if (isNull(data)) {
...
var Links = class {
  constructor() {
    ...
    __publicField(this, "opacity", 1);
    __publicField(this, "shadow", new LinksShadow());
    __publicField(this, "triangles", new LinksTriangle());
    __publicField(this, "warp", false);
...
var _maxDistance10, _pluginManager11, _Linker_instances, getLinkColor_fn, setColor_fn;
var Linker = class extends ParticlesInteractorBase {
  constructor(pluginManager, container) {
    super(container);
    __privateAdd(this, _Linker_instances);
    __privateAdd(this, _maxDistance10);
    __privateAdd(this, _pluginManager11);
    __privateSet(this, _pluginManager11, pluginManager);
    __privateSet(this, _maxDistance10, 0);
  }
  get maxDistance() {
    return __privateGet(this, _maxDistance10);
  }
  clear() {
  }
  init() {
  ...
  interact(p1) {
    ...
    p1.links = [];
    if (p1.linksDistance && p1.linksDistance > __privateGet(this, _maxDistance10)) {
      __privateSet(this, _maxDistance10, p1.linksDistance);
    }
    ...
    for (const p2 of query) {
      ...
      __privateMethod(this, _Linker_instances, setColor_fn).call(this, p1);
      p1.links.push({
        destination: p2,
        opacity: opacityLine,
        color: __privateMethod(this, _Linker_instances, getLinkColor_fn).call(this, p1, p2),
...
_maxDistance10 = new WeakMap();
_pluginManager11 = new WeakMap();
_Linker_instances = new WeakSet();
getLinkColor_fn = function(p1, p2) {
...
setColor_fn = function(p1) {
  ...
  linkColor = getLinkRandomColor(__privateGet(this, _pluginManager11), linksOptions.color, linksOptions.blink, linksOptions.consent);
...
var _pluginManager12;
var LinksPlugin = class {
  constructor(pluginManager) {
    __publicField(this, "id", "links");
    __privateAdd(this, _pluginManager12);
    __privateSet(this, _pluginManager12, pluginManager);
  }
  async getPlugin(container) {
    const { LinkInstance } = await import("./LinkInstance-L2CHELB2.js");
    return new LinkInstance(__privateGet(this, _pluginManager12), container);
  }
  loadOptions() {
  }
  needsPlugin() {
...
var Rotate = class extends ValueWithRandom {
  constructor() {
    super(...arguments);
    __publicField(this, "animation", new RotateAnimation());
    __publicField(this, "direction", RotateDirection.clockwise);
    __publicField(this, "path", false);
  }
  load(data) {
    if (isNull(data)) {
      return;
...
var RotateUpdater = class {
  constructor(container) {
    ...
    __privateSet(this, _container11, container);
  }
  init(particle) {
    ...
    if (rotateAnimation.enable) {
      ...
      particle.rotate.velocity = getRangeValue(rotateAnimation.speed) / doublePIDeg * __privateGet(this, _container11).retina.reduceFactor;
...
function drawText(data) {
  ...
  particle.maxTextLength ?? (particle.maxTextLength = particle.textLines.length ? Math.max(...particle.textLines.map((t) => t.length)) : ((_b = particle.textLines[firstIndex]) == null ? void 0 : _b.length) ?? minLength);
...
var TextDrawer = class {
  ...
  particleInit(_container15, particle) {
    ...
    particle.maxTextLength = particle.textLines.length ? Math.max(...particle.textLines.map((t) => t.length)) : ((_b = particle.textLines[firstIndex2]) == null ? void 0 : _b.length) ?? minLength2;
  }
};
...
var Tilt = class extends ValueWithRandom {
  constructor() {
    super(...arguments);
    __publicField(this, "animation", new TiltAnimation());
    __publicField(this, "direction", TiltDirection.clockwise);
    __publicField(this, "enable", false);
  }
  load(data) {
    super.load(data);
...
var TiltUpdater = class {
  constructor(container) {
    ...
    __privateSet(this, _container12, container);
  }
  getTransformValues(particle) {
    var _a;
  ...
  init(particle) {
    ...
    if (tiltAnimation == null ? void 0 : tiltAnimation.enable) {
      ...
      particle.tilt.velocity = getRangeValue(tiltAnimation.speed) / maxAngle3 * __privateGet(this, _container12).retina.reduceFactor;
...
var TwinkleLinksValues = class {
  constructor() {
    __publicField(this, "color");
    __publicField(this, "enable", false);
    __publicField(this, "frequency", 0.05);
    __publicField(this, "opacity", 1);
  }
  load(data) {
    if (isNull(data)) {
...
var Twinkle = class {
  constructor() {
    __publicField(this, "links", new TwinkleLinksValues());
    __publicField(this, "particles", new TwinkleParticlesValues());
  }
  load(data) {
    if (isNull(data)) {
      return;
...
var _container13, _pluginManager13;
var TwinkleUpdater = class {
  constructor(pluginManager, container) {
    __privateAdd(this, _container13);
    __privateAdd(this, _pluginManager13);
    __privateSet(this, _pluginManager13, pluginManager);
    __privateSet(this, _container13, container);
  }
  getColorStyles(particle, _context, _radius, opacity) {
    const pOptions = particle.options, container = __privateGet(this, _container13), twinkleOptions = pOptions["twinkle"];
    if (!twinkleOptions) {
      return {};
    }
    const twinkle = twinkleOptions.particles, twinkling = twinkle.enable && getRandom() < twinkle.frequency, zIndexOptions = particle.options.zIndex, zOffset = 1, zOpacityFactor = (zOffset - particle.zIndexFactor) ** zIndexOptions.opacityRate, twinklingOpacity = twinkling ? getRangeValue(twinkle.opacity) * zOpacityFactor : opacity, twinkleFillRgb = rangeColorToHsl(__privateGet(this, _pluginManager13), twinkle.fillColor), twinkleStrokeRgb = rangeColorToHsl(__privateGet(this, _pluginManager13), twinkle.strokeColor), getTwinkleFillStyle = () => {
      if (!twinkleFillRgb) {
        return void 0;
      }
...
var WobbleSpeed = class {
  constructor() {
    __publicField(this, "angle", 50);
    __publicField(this, "move", 10);
  }
  load(data) {
    if (isNull(data)) {
      return;
...
var Wobble = class {
  constructor() {
    ...
    __publicField(this, "enable", false);
    __publicField(this, "speed", new WobbleSpeed());
  }
  load(data) {
    if (isNull(data)) {
      return;
...
var WobbleUpdater = class {
  constructor(container) {
    __privateAdd(this, _container14);
    __privateSet(this, _container14, container);
  }
  init(particle) {
    ...
    particle.retina.wobbleDistance = getRangeValue((wobbleOpt == null ? void 0 : wobbleOpt.distance) ?? defaultDistance2) * __privateGet(this, _container14).retina.pixelRatio;
  }
  isEnabled(particle) {
    var _a;
  ...
  update(particle, delta) {
    ...
    updateWobble(__privateGet(this, _container14), particle, delta);
  }
};
_container14 = new WeakMap();
