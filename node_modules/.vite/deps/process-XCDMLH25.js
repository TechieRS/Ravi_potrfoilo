...
async function Module(moduleArg = {}) {
  ...
  var getEnvStrings = () => {
    ...
    if (!getEnvStrings.strings) {
      var lang = (((_a = globalThis.navigator) == null ? void 0 : _a.language) ?? "C").replace("-", "_") + ".UTF-8";
  ...
  var FS_stdin_getChar = () => {
    ...
    if (!FS_stdin_getChar_buffer.length) {
      var result = null;
      if ((_a = globalThis.window) == null ? void 0 : _a.prompt) {
  ...
  var TTY = { ttys: [], init() {
    ...
    var _a;
    if (((_a = tty.output) == null ? void 0 : _a.length) > 0) {
      out(UTF8ArrayToString(tty.output));
      tty.output = [];
    }
  }, ioctl_tcgets(tty) {
...
//# sourceMappingURL=process-XCDMLH25.js.map
